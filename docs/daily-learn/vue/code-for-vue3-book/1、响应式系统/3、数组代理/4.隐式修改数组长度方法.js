...
/**
 * 这里主要指 push/pop/shift/unshift/splice 方法
 * 以 push 方法为例 https://262.ecma-international.org/13.0/#sec-array.prototype.push 方法执行的过程会访问 length 属性，同时也会设置 length 属性
 */
// 未处理前，下面会导致栈溢出
const arr = reactive([]);
effect(() => {
